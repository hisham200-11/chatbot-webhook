...
// ============================================================
// Privacy Policy & Data Deletion (Required by Meta for Live Mode)
// ============================================================
app.get('/privacy-policy', (req, res) => {
    ...
    res.send(`
        ...
        <head>
            ...
            <title>Privacy Policy - ${CLINIC_NAME}</title>
            <style>
                ...
                .footer { margin-top: 40px; font-size: 0.9em; color: #718096; border-top: 1px solid #e2e8f0; padding-top: 16px; }
            </style>
        </head>
        <body>
            <h1>Privacy Policy</h1>
            <p><strong>Last Updated:</strong> August 2026</p>
            <p>This Privacy Policy describes how <strong>${CLINIC_NAME}</strong> ("we", "us", or "our") collects, uses, and protects your information when you interact with our Facebook Messenger Chatbot.</p>
            
            <h2>1. Information We Collect</h2>
            <p>When you interact with our chatbot, we may collect:</p>
            <ul>
                <li><strong>Facebook Page-Scoped ID (PSID):</strong> An identifier generated by Facebook to deliver messages to you.</li>
                <li><strong>Voluntarily Provided Lead Information:</strong> Your name, phone number, dental procedure of interest, and preferred consultation schedule when you request an appointment.</li>
            </ul>

            <h2>2. How We Use Your Information</h2>
            <p>We use the collected information strictly for:</p>
            <ul>
                <li>Answering your inquiries about dental services, pricing ranges, and clinic schedules.</li>
                <li>Booking and confirming your requested dental consultations and 3D smile scans.</li>
                <li>Connecting you with our licensed clinic staff or head dentist for human support.</li>
            </ul>

            <h2>3. Information Sharing & Security</h2>
            <p>We <strong>do not</strong> sell, rent, or trade your personal data to third parties. All lead data is securely stored and only accessible by authorized clinic staff.</p>

            <h2>4. Data Retention & Deletion</h2>
            <p>You may request the deletion of your conversation history and contact information at any time by sending a message in the chat or contacting us at <a href="mailto:${process.env.ADMIN_EMAIL || 'support@clinic.com'}">${process.env.ADMIN_EMAIL || 'support@clinic.com'}</a>.</p>
...
app.get('/data-deletion', (req, res) => {
    ...
    res.send(`
        ...
        <head>
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>User Data Deletion Instructions - ${CLINIC_NAME}</title>
            <style>
                body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; line-height: 1.6; max-width: 800px; margin: 40px auto; padding: 0 20px; color: #2d3748; }
                h1 { color: #1a365d; border-bottom: 2px solid #e2e8f0; padding-bottom: 12px; }
            </style>
        ...
        <body>
            ...
            <p>At <strong>${CLINIC_NAME}</strong>, we respect your privacy and provide an easy way to delete your data.</p>
            <p>If you want your Facebook Messenger chat history and contact information removed from our database, follow these simple steps:</p>
            <ol>
                <li>Send a message saying <strong>"Delete my data"</strong> directly to our Facebook Page in Messenger.</li>
                <li>Or email your request to <a href="mailto:${process.env.ADMIN_EMAIL || 'support@clinic.com'}">${process.env.ADMIN_EMAIL || 'support@clinic.com'}</a> with your Facebook name.</li>
            </ol>
            <p>Our team will permanently wipe your records from our database within 24 hours.</p>
        </body>
        </html>
    `);
});
